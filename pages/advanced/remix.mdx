...
3. Add your network to Metamask using these parameters from Gobbl Chain:
    - Network Name: Gobbl
    - New RPC URL: https://gobbl-testnet.rpc.caldera.xyz/http
    - Chain ID: 486487
    - Currency Symbol: GOBBL
    - Block Explorer URL: https://gobbl-testnet.explorer.caldera.xyz/
